  ...
  return (
    <div className="flex flex-col h-full bg-white rounded-xl shadow-lg overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-gray-50 border-b">
        <h2 className="font-semibold text-gray-700">Subtitles</h2>
      ...
      >
        {subtitles.length === 0 ? (
          <div className="text-center py-8 text-gray-500">
            ...
            <p className="text-sm mt-1">Try using Whisper transcription.</p>
          </div>
        ) : (
          subtitles.map((segment, index) => (
            <div
              ...
              data-index={index}
              className={`
                subtitle-segment p-3 rounded-lg cursor-pointer
                ${index === currentSegmentIndex ? 'active bg-primary-100 border-l-4 border-primary-500' : 'hover:bg-gray-50'}
              `}
            ...
            >
              <div className="flex items-start gap-3">
                <span className="text-xs text-gray-400 font-mono mt-1 min-w-[40px]">
      ...
      {selectedWord && (
        ...
        >
          ...
          {selectedWord.entry ? (
            ...
            <p className="text-sm text-gray-500 mt-1">No definition found</p>
          )}
        </div>
      )}
    </div>

          ...
          subtitles.map((segment, index) => (
            <div
              ...
              className={`
                ...
                ${index === currentSegmentIndex 
                  ? 'active bg-orange-500/10 border-orange-500 shadow-md' 
                  : 'hover:bg-dark-lighter border-dark-border hover:border-dark-border'}
              `}
            ...
            >
              <div className="flex items-start gap-3">
                <span className="text-xs text-dark-textSecondary font-mono mt-1 min-w-[45px] bg-dark-lighter px-1.5 py-0.5 rounded">
                  {formatTime(segment.start)}
                </span>
                <div className="flex-1 min-w-0">
                  {/* 英文原文 - 带高亮 */}
                  <p 
                    className="text-dark-text leading-relaxed font-medium"
